...
This project is indexed by GitNexus as **ulp** (11552 symbols, 30674 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ulp/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ulp/clusters` | All functional areas |
| `gitnexus://repo/ulp/processes` | All execution flows |
| `gitnexus://repo/ulp/process/{name}` | Step-by-step execution trace |
